...
export function HeroSection() {
  return <div className="hero-gradient overflow-hidden">
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-md">Ever felt your event photos are too boring and if you could get that one candid photo? Recollect lets your guests instantly share party memories in one place — with just a scan.</p>
            ...
            <div className="relative animate-float">
              <div className="bg-white p-6 rounded-3xl shadow-lg max-w-sm mx-auto">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {Array.from({
                  length: 6
                }).map((_, i) => <div key={i} className="aspect-square bg-lavender/60 rounded-lg overflow-hidden">
